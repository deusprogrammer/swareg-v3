	...
	<body>
		<div id="main-container">
	        ...
	        <div id="session">
	            <sec:ifLoggedIn>
	            	<table>
	                	<tr><td><g:gravatar size="50" /></td><td style="vertical-align: middle;"><g:link class="menu-link" controller="userFlow" action="edit"><sec:username/></g:link>|<g:link class="menu-link" controller='userFlow' action="logout">Logout</g:link></td></tr>
	                </table>
	            </sec:ifLoggedIn>
	        </div>
	        <div id="body-content">

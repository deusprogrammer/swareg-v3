			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="role.event.label" default="Event" /></th>
					
						<g:sortableColumn property="role" title="${message(code: 'role.role.label', default: 'Role')}" />
					
						<th><g:message code="role.user.label" default="User" /></th>
				...
				<g:each in="${roleInstanceList}" status="i" var="roleInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${roleInstance.id}">${fieldValue(bean: roleInstance, field: "event")}</g:link></td>
